...
configChatbot.replicas = {
  bot: {
    0: {
      content: 'Привет! Я Инфинити - бот поддержки сайта SNEAKER STORE, можно просто SNEAK', human: [0, 1, 2]
    },
    ...
    4: { content: '{{name}}, для этого добавьте выбранный товар в корзину, нажмите ADD TO CARD, и переведите деньги на номер *************', human: [6] },
  ...
  human: {
    ...
    2: { content: 'Приветик, SNEAK!', bot: 2 },
    3: { content: '', bot: 3, name: 'name' },
    4: { content: 'Как оформить заказ?', bot: 4 },
